...
% 3. Unsupervised ML
To complement these capabilities...

Therefore, unsupervised techniques to segment HSI and identify unique spectral signatures are needed for near-real time applications where detailed knowledge of contaminants may not be available
