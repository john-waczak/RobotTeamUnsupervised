...
- Spectral signatures of classes are complex and often overlapping \cite{thenkabail2018hyperspectral}
...
- common approach is inversion of optically-active water quality parameters such as chlorophyll-a, blue-green algae, turbidity, and temperature \cite{ritchie2003remote}
