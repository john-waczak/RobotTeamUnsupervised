...
UAV-based hyperspectral imagers have been used estimate chlorophyll-a, suspended solids, and  
Many such systems have been utilized for the characterization of water quality and composition (cite examples).
\cite{lu2021retrieval}
\cite{zhang2022selection}



The collection of requisite in situ data can be significantly accelerated by coordinating UAV flights with reference-sensor equipped autonomous boats \cite{robot-team-1, robot-team-2}. 
However, this approach requires prior knowledge of expected contaminants in order to select relevant sensors 
