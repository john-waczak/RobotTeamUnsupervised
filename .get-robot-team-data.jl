...
datapaths = Dict(
    "full" => "/Users/johnwaczak/data/robot-team/finalized/Full/df_full.csv",
    "11-23" => "/Users/johnwaczak/data/robot-team/finalized/Full/df_11_23.csv",
)

@assert ispath(datapaths["full"])
@assert ispath(datapaths["11-23"])
